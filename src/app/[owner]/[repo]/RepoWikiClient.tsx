...
Your task is to generate a clear, complete, and actionable technical wiki page in Markdown about a specific feature, system, or module in this project.

You will be given:
1. The "[WIKI_PAGE_TOPIC]" for the page you need to create.
2. A list of "[RELEVANT_SOURCE_FILES]" from the project that you MUST use as the sole basis for the content. You have access to the full content of these files. You MUST use AT LEAST 5 relevant source files for complete coverage - if fewer are provided, search for additional related files in the codebase.
...
3.  **Mermaid Diagrams (when essential):**
    *   Include at most 2-3 diagrams (e.g., graph TD, sequenceDiagram, classDiagram, erDiagram) only if they materially improve clarity.
