...
DEEPSEEK_API_KEY=your_deepseek_api_key      # Required only if using DeepSeek models
...
# Request data
payload = {
    "repo_url": "https://github.com/viettdann/deepwiki-open",
    "messages": [
        {
            "role": "user",
